  ...
  ({ className, rootHeight, rootWidth, thumbSize, ...props }, ref) => (
    ...
    >
      <SwitchPrimitives.Thumb
        className={cn(
          `pointer-events-none block h-${thumbSize} w-${thumbSize} rounded-full bg-background shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0`
        )}
      />
    </SwitchPrimitives.Root>
  )
